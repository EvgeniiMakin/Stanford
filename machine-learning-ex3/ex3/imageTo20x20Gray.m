...
%
% (Thanks to Edwin Frhwirth for parts of this code)

% Read as RGB image
Image3DmatrixRGBp = imread(fileName);
Image3DmatrixRGB = im2double(Image3DmatrixRGBp);
[h,w,d] = size(Image3DmatrixRGB);
% Convert to NTSC image (YIQ)
Image3DmatrixRGB = reshape(Image3DmatrixRGB, h*w,d);
Image3DmatrixYIQ = rgb2ntsc(Image3DmatrixRGB);
Image3DmatrixYIQ = reshape(Image3DmatrixYIQ, h,w,d);
...
newAlignedImage = rot90(newAlignedImage, rotStep);
